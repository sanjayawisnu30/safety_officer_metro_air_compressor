...
# --- 1. DEFINISI JADWAL KEGAGALAN (GROUND TRUTH) ---
FAILURE_PERIODS = [
...
def run_training():
    ...
    with mlflow.start_run(run_name="LSTM_F1_Optimized_Run"):
        ...
        # --- 2. PREPARATION (DATA TRAIN: FEB-MAR) ---
        print("⚙️ [TRAINING] Memproses Data Sehat (Feb-Mar)...")
        ...
        # --- 4. EVALUASI & KALIBRASI (DATA TEST: APR-AUG) ---
        print("⚖️ [EVALUASI] Menyiapkan Data Uji (April-Agustus)...")
        # Mengambil sisa data setelah bulan Maret untuk evaluasi
        ...
        # Menyelaraskan Timestamp: Sequence 30 data menghasilkan prediksi di waktu ujung (TIME_STEPS - 1)
